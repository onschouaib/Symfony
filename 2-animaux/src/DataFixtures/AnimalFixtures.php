...
class AnimalFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $c1->setLibelle("mammifères")
            ->setDescription("Animaux vertébres nourissant leurs petits avec du lait");
        $manager->persist($c1);    
        
        $c2 = new Famille();
        $c2->setLibelle("reptiles")
            ->setDescription("Animaux vertébres qui rampent");
        $manager->persist($c2);

        $c3 = new Famille();
        $c3->setLibelle("poissons")
            ->setDescription("Animaux vertébres du monde aquatique");
        $manager->persist($c3);
